...
def find_differences(mesh1, mesh2, field='S_Mises'):
    """Compare two meshes and store difference in a new mesh"""
    data1 = mesh1[field]
    data2 = mesh2[field]

    # Differenz berechnen (positiv = Zunahme)
    diff = data2 - data1

    # Neues Mesh erstellen, das die Differenz enthält
    diff_mesh = mesh1.copy(deep=True)  # Mesh kopieren, nicht das Original verändern
