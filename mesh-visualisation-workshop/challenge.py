...
class StressAnalyzer:
    ...
    def __init__(self, mesh_file):
        ...
        print("Netz und Spannung wurde eingelesen")
    ...
    def get_critical_regions(self, threshold):
        ...
        print("Es wird jeder Punkt kontrolliert, ob Spannung höher als Grenzwert ist, dann wird der Punkt im Array critical_indices dazu gespeichert")
    ...
    def calculate_statistics(self):
        ...
        print("Berechnung der min, max, mean und std für die Berechung des Sicherheitsfaktors")
        # Calculate safety factor (max allowable / actual)
        max_allowable = 7.0  # MPa
...
analyzer.visualize_critical(threshold=1.0)
