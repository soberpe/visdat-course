...
class StressAnalyzer:
    ...
    def get_critical_regions(self, threshold):
        ...
        #     if self.stress[i] > threshold:      #Änderung der Bedingung von kleiner auf größer
    ...
    def calculate_statistics(self):
        ...
        stats["safety_factor"] = max_allowable / self.stress.max()  #Änderung der Formel für Sicherheitsfaktor
