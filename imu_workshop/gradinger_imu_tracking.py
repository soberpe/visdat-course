...
#What you will do:
#Record accelerometer and gyroscope data using a smartphone app
#Load and preprocess the sensor measurements in Python
#Estimate the device orientation over time using the Madgwick algorithm
#Transform local accelerations into a global reference frame using quaternion rotations
#Integrate accelerations twice to obtain velocity and position
#Visualize the reconstructed 3D trajectory and analyze error sources
#What you will learn:
...
# The mobile phone was hold keeping still for 2-3 seconds in the hand and moved from left to right, about 60cm, without making differences in the height (Z-Axis) and the holding still for another 2-3 seconds.

#Part 2: Data Import and Preprocessing

#Load and Normalize the Dataset-Option B
import pandas as pd
import numpy as np
...
# Load separate files
accel_df = pd.read_csv('imu_workshop/data/raw/gradinger_acceleration.csv')
gyro_df = pd.read_csv('imu_workshop/data/raw/gradinger_gyroscope.csv')
