...
# Load separate files
accel_df = pd.read_csv('data/raw/Lindmair_acceleration3.csv')
gyro_df = pd.read_csv('data/raw/Lindmair_gyroscope3.csv')
...
# Change the data type of time from int64 auf float
accel_df['time'] = accel_df['time'].astype(float)
gyro_df['time']  = gyro_df['time'].astype(float)

# Transformation of the time data from millisecond (ms) to seconds (s)
...
# Delete the first 1.5s and last 2s of the mesurement to avoid NaN values after merging
df = df[(df['time'] >= 1.5) & (df['time'] <= df['time'].max() - 2.0)]
...
plt.tight_layout()
plt.savefig(r"C:\Users\Public\Documents\FH\Master\WS2025_26\VIS3\UE\Gregor-Lindmair\imu-workshop\01_raw_sensor_data.png", dpi=300)
plt.show()
...
plt.tight_layout()
plt.savefig(r"C:\Users\Public\Documents\FH\Master\WS2025_26\VIS3\UE\Gregor-Lindmair\imu-workshop\02_filtered_acceleration.png", dpi=300)
plt.show()
...
plt.tight_layout()
plt.savefig(r"C:\Users\Public\Documents\FH\Master\WS2025_26\VIS3\UE\Gregor-Lindmair\imu-workshop\03_orientation_euler.png", dpi=300)
plt.show()
...
plt.tight_layout()
plt.savefig(r"C:\Users\Public\Documents\FH\Master\WS2025_26\VIS3\UE\Gregor-Lindmair\imu-workshop\04_global_acceleration.png", dpi=300)
plt.show()
...
plt.tight_layout()
plt.savefig(r"C:\Users\Public\Documents\FH\Master\WS2025_26\VIS3\UE\Gregor-Lindmair\imu-workshop\05_velocity.png", dpi=300)
plt.show()
...
plt.legend()
plt.tight_layout()
plt.savefig(r"C:\Users\Public\Documents\FH\Master\WS2025_26\VIS3\UE\Gregor-Lindmair\imu-workshop\06_trajectory_2d.png", dpi=300)
plt.show()
...
plt.tight_layout()
plt.savefig(r"C:\Users\Public\Documents\FH\Master\WS2025_26\VIS3\UE\Gregor-Lindmair\imu-workshop\07_trajectory_3d.png", dpi=300)
plt.show()
...
plt.tight_layout()
plt.savefig(r"C:\Users\Public\Documents\FH\Master\WS2025_26\VIS3\UE\Gregor-Lindmair\imu-workshop\08_zupt_comparison.png", dpi=300)
plt.show()
