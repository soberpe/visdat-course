...
#Load and rename data from sensor
# Load separate files
accel_df = pd.read_csv('imu-workshop/data/raw/Gattringer_acceleration_UForm.csv')
gyro_df = pd.read_csv('imu-workshop/data/raw/Gattringer_gyroscope_UForm.csv')
...
#Convert Quaterions to Euler-Angles
...
plt.tight_layout()
plt.savefig('imu-workshop/figures/05_velocity.png', dpi=300)
plt.show()
...
actual_distance = 1.1  # meters (your measurement)
...
plt.tight_layout()
plt.savefig('imu-workshop/figures/08_zupt_comparison.png', dpi=300)
plt.show()